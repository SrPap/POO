...
public class LigaFutbol {
    ...
    private static void metergol() {
        ...
        mostrarListaJugadores();
        System.out.print("Seleccione el número del jugador que realizo el gol: ");
        int opcionJugador = sc.nextInt();
        sc.nextLine();
    ...
    private static void gritarGol() {
        ...
        mostrarListaJugadores();
        System.out.print("Seleccione el número del jugador que desee gritarle gol: ");
        int opcionJugador = sc.nextInt();
        sc.nextLine();
